...
.edgeLabel[data-look="neo"] {
  ...
  ${(0,b.getIconStyles)()}
`,"getStyles"),u=(0,j.__name)((a,b="TB")=>{if(!a.doc)return b;let c=b;for(let b of a.doc)"dir"===b.stmt&&(c=b.value);return c},"getDir"),v=(0,j.__name)(function(a,b){return b.db.getClasses()},"getClasses"),w=(0,j.__name)(async function(a,b,f,j){i.log.info("REF0:"),i.log.info("Drawing class diagram (v3)",b);let{securityLevel:k,state:l,layout:m}=(0,h.getConfig2)();j.db.setDiagramId(b);let n=j.db.getData(),o=(0,c.getDiagramElement)(b,k);n.type=j.type,n.layoutAlgorithm=(0,e.getRegisteredLayoutAlgorithm)(m),n.nodeSpacing=l?.nodeSpacing||50,n.rankSpacing=l?.rankSpacing||50,n.markers=["aggregation","extension","composition","dependency","lollipop"],n.diagramId=b,await (0,e.render)(n,o),g.utils_default.insertTitle(o,"classDiagramTitleText",l?.titleTopMargin??25,j.db.getDiagramTitle()),(0,d.setupViewPortForSVG)(o,8,"classDiagram",l?.useMaxWidth??!0)},"draw");a.s(["ClassDB",0,s,"classDiagram_default",0,m,"classRenderer_v3_unified_default",0,{getClasses:v,draw:w,getDir:u},"styles_default",0,t])}];

//# sourceMappingURL=node_modules_mermaid_dist_chunks_mermaid_core_chunk-V7JOEXUC_mjs_19cbrp7._.js.map